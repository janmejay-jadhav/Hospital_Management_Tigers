    ...
    <div align="center">
      <div className="happy">
        ...
        <div>
          ...
          <p>
            {" "}
            We are the team with an ambition to provide the people best and
            affordable treatment for everyone.
            <br />
            So we are ready to help you out with our best possible way with the
            use of best Technology and best team of the Doctors.
          </p>
              ...
              <Card sx={{ maxWidth: 345 }} className="kk">
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    Specialists for skin and hair treatments Rashes, Pimples,
                    Acne, Hairfall, Dandruff
                  </Typography>
                </CardContent>
                <CardActions>
              ...
              <Card sx={{ maxWidth: 345, height: "100%" }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    Managing acute medical conditions Typhoid, Abdominal Pain,
                    Migraine, Infections
                  </Typography>
                </CardContent>
                <CardActions>
              ...
              <Card sx={{ maxWidth: 345, height: "100%" }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Dr.Helen Perry
                    <br />
                    Specialists to care and treat children Constipation,
                    Puberty, Nutrition, Autism
                  </Typography>
                </CardContent>
                <CardActions>
                  <Button size="small">Share</Button>
            ...
            <Grid>
              <Card sx={{ maxWidth: 345, height: "100%" }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Top Rated Team of Doctors Includes all Specialities
                  </Typography>
                </CardContent>
                <CardActions>
                  <Button size="small">Share</Button>
                ...
                <div>
                  ...
                  <div className="welcome">
                    <Grid item>
                      ...
                      <Popper id={id} open={open} anchorEl={anchorEl}>
                        <Box sx={{ border: 1, p: 1, bgcolor: "Grey" }}>
                          ...
                          coronary thrombosis. Clots form inside the blood
                          vessels of the heart, thereby, blocking the blood flow
                          and starving the heart muscles of oxygen. As a result,
                          the tissues of the heart begin to die. There are
                          various heart diseases identified till now, however,
                          one of the most common causes of death is coronary
                          thrombosis. Based on the location of the clot,
                          symptoms may or may not be present, but typically,
                          ...
                          5 Sudden chest pain.
                          <br />
                          6 Shooting pain in the left hand.
                          <br />
                          7 Discomfort in other areas of the upper body.
                          <br />
                          8 Tightness/ sensation of squeezing in the chest.
                          <br />
                        </Box>
                      </Popper>
                    </Grid>
                    <Grid item>
                      ...
                      <Popper id={id} open={open} anchorEl={anchorEl}>
                        <Box sx={{ border: 1, p: 1, bgcolor: "Grey" }}>
                          Everyone has slightly different readings for their
                          normal blood pressure, it primarily depends on the
                          person’s age, lifestyle, size etc. For instance, a
                          highly trained athlete has a considerably lower
                          resting blood pressure when compared to a normal
                          individual.
                          <br /> Therefore, low bp may not be an issue until
                          they start causing undesirable symptoms.
                          <br />
                          Characteristic Low BP symptoms include: 1 Dizziness
                          <br />
                          2 Light-headedness
                          <br />
                          3 Fatigue
                          <br />
                          4 Fading/blurred vision
                          <br />
                          5 Lack of concentration
                          <br />
                          6 Dryness of throat/ thirst
                          <br />
                          Low BP symptoms can be counteracted by following a
                          healthier lifestyle. These include proper intake of
                          salt, reducing alcohol, regular exercises etc.
                        </Box>
                      </Popper>
                    </Grid>
                    <Button
                    ...
                    <Popper id={id} open={open} anchorEl={anchorEl}>
                      <Box sx={{ border: 1, p: 1, bgcolor: "Grey" }}>
                        ...
                        typically as a result of an illness.
                        <br /> A fever is a sign that our body cells are
                        fighting and eliminating a number of infections from our
                        body.
                        <br />
                    ...
                    <Popper id={id} open={open} anchorEl={anchorEl}>
                      <Box sx={{ border: 1, p: 1, bgcolor: "Grey" }}>
                        Stroke is a disease that has a long list of risk
                        factors. Individuals who are suffering from heart
                        disease, hypertension, diabetes have a higher risk of
                        stroke.
                        <br /> Individuals who smoke are also more prone to
                        strokes.
                        <br /> Common characteristic symptoms of stroke include:
                        <br />
