...
function About() {
  ...
  return (
    <Box align="center" style={{ marginTop: "5em" }}>
      <Box className="happy">
        ...
        <Box sx={12} md={3}>
          ...
          <p>
            Our Doctors make an important contribution to the management and
            leadership of health services and the delivery of healthcare across
            the India as part of a multidisciplinary team. All doctors have some
            responsibilities for using resources; many will also lead teams or
            be involved in supervising colleagues.
          </p>
          <p>
            Our Doctor are responsible for all sides of care of a patient. They
            diagnose, educate, and treat patients to ensure that they have the
            ...
            document patient's medical history, and educating patients. They
            also have to administer vaccines and other treatments. Some of the
            jobs titles that a doctor could grow into are head of research or
            hospital president.
          </p>
        </Box>
        ...
        <Grid container spacing={2} display="flex" justifyContent="center">
          ...
          <Grid item xs={12} md={3}>
            <Card sx={{ maxWidth: 280, height: "100%" }} className="wish">
              ...
              <CardContent>
                <img
                  src="assets/about-doctor-bg.jpg"
                  alt="doctor"
                  className="im"
                ></img>
                <Typography gutterBottom variant="h5" component="div">
            ...
            <Card sx={{ maxWidth: 280, height: "100%" }} className="wish">
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Dr.Helen Perry
                  <br />
                  Specialists to care and treat children Constipation, Puberty,
                  Nutrition, Autism
                </Typography>
              </CardContent>
        ...
        >
          <Grid item md={4}>
            ...
            <p>
              ...
              <br /> A Hippocratic Oath for Doctors I solemnly pledge myself
